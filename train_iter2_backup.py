...
def main() -> None:
    ...
    if cfg.dataset_source == "folder":
    ...
    elif cfg.dataset_source == "csv":
        full_dataset = CSVMAVCelebDataset(
        ...
        raise ValueError(
            f"Unknown DATASET_SOURCE={cfg.dataset_source!r}. Choose from folder, csv."
        )
